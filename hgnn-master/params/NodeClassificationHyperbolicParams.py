...
def add_params(parser):
    parser.add_argument('--dataset_str', type=str, 
                        default='pubmed', choices=['citeseer', 'cora', 'pubmed', 'USA', 'Brazil', 'Europe', 'Cornell', 'Texas', 'Wisconsin'])   
    ...
    parser.add_argument('--activation', type=str, default='relu', choices=['relu', 'leaky_relu', 'rrelu', 'elu', 'prelu', 'selu'])
