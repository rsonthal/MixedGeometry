...
from manifold.LorentzManifold import LorentzManifold
...
class LinkPrediction(nn.Module):
	...
	def forward(self, adj, weight, features, pos_index, neg_index):
		"""
		Args:
    ...
    # ldot here
		pos_neg_index = th.cat([pos_index, neg_index], dim=-1).int() # concatenate pos and neg edges
		logits = LorentzManifold.ldot(node_repr[pos_neg_index[0]], node_repr[pos_neg_index[1]])
		return logits
