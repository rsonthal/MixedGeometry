...
import numpy as np
from task import *
from task.LinkPredictionTask import LinkPredictionTask
from task.NodeClassificationTaskEval import NodeClassificationTaskEval
from task.LinkPredictionTaskEval import LinkPredictionTaskEval
from task.TimeNodeClassificationTask import NodeClassificationTask
import os
import time
from utils import *
from params import *
from params import LinkPredictionHyperbolicParams
import sys
...
def parse_default_args():
    ...
    if args.task == 'ethereum' and args.select_manifold == 'euclidean':
        ...
        LinkPredictionHyperbolicParams.add_params(parser)
...
if __name__ == '__main__':
    ...
    if args.task == 'ethereum':
        ...
        gnn_task = LinkPredictionTaskEval(args, logger, rgnn, manifold)
    ...
    gnn_task.run_gnn(args.trial_number)
