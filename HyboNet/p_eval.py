...
def train(args):
    ...
    filename = "dataset=" + dataset2name[args.dataset] + "_layers=" + str(num_layer) + \
    ...
    model_dict = torch.load(f'HGNNs/{model_name}/models/{filename}')
    ...
    with torch.no_grad():
        ...
        print(prf)
        torch.save(prf, f'HGNNs/{model_name}/results/prf/{filename}')
