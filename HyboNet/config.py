...
config_args = {
    'training_config': {
        ...
        'momentum': (1, 'momentum in optimizer'),
        'patience': (100, 'patience for early stopping'),
        'seed': (int(time.time()), 'seed for training'),
        ...
        'gamma': (1, 'gamma for lr scheduler'),
        'print-epoch': (True, ''),
        'grad-clip': (None, 'max norm for gradient clipping, or None for no gradient clipping'),
        'min-epochs': (100, 'do not early stop before min-epochs')
    },
    'model_config': {
        'trial': (1, 'index of independent trials'),
        ...
        'act': ('leaky_relu', 'which activation function to use (or None for no activation)'),
