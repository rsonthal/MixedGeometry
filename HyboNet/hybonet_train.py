    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            if (epoch + 1) % args.eval_freq == 0:
                ...
                #d[model_name][num_layer][dim][lr][int(trial)][int(epoch+1)]['auc_train'] = train_metrics['acc']
                #d[model_name][num_layer][dim][lr][int(trial)][int(epoch+1)]['auc_val'] = val_metrics['acc']
                #d[model_name][num_layer][dim][lr][int(trial)][int(epoch+1)]['auc_test'] = test_metrics['acc']
                ...
                if model.has_improved(best_val_metrics, val_metrics):
                    ...
                    best_accs = (train_metrics['acc'], val_metrics['acc'], test_metrics['acc'])
