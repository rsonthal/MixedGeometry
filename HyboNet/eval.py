...
def train(args):
    ...
    model_dict = torch.load(f'/content/myDrive/MyDrive/HGNNs_Link_Prediction/{model_name}/models/{filename}')
    ...
    with torch.no_grad():
        ...
        print(prf)
        torch.save(prf, f'/content/myDrive/MyDrive/HGNNs_Link_Prediction/{model_name}/results/prf/{filename}')
